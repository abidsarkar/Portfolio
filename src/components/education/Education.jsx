    ...
    <section id="education" className="py-16 px-6 bg-darkBrown text-white">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-around gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          {/* BSc */}
          <motion.div
            className="w-full h-auto bg-white rounded-xl py-1 mb-6"
            initial={{ x: "100%", opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ type: "spring", stiffness: 100, duration: 1 }}
          >
            <img src="./image/ewulogo.png" alt="EWU Logo" />
          </motion.div>
          ...
          <motion.div
            className="mt-6 p-6 bg-gray-800 rounded-xl shadow-lg"
            initial={{ x: "100%", opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ type: "spring", stiffness: 100, duration: 1 }}
          >
